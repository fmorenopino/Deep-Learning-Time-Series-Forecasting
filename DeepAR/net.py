        ...
        if sampling:
            ...
            for j in range(self.params.sample_times):
                ...
                for t in range(self.params.predict_steps):
                    mu_de, sigma_de, decoder_hidden, decoder_cell = self(x[self.params.test_predict_start + t].unsqueeze(0),
                    ...
                    if t < (self.params.predict_steps - 1):
                        x[self.params.test_predict_start + t + 1, :, 0] = pred
            ...
            for t in range(self.params.predict_steps):
                ...
                if t < (self.params.predict_steps - 1):
                    x[self.params.test_predict_start + t + 1, :, 0] = mu_de
